...
/*System.out.println("the two is " + lastblock[0]);	
for(int i=0; i<src.length; i++) {
	if(i >= totalblock*partsize && i <totalblock*partsize + 10) {
		System.out.println("the one is " + src[i]);
	}
}
...
/*				for(int i=0; i<lastencryptblock.length; i++) {
					if(i<10) {
						System.out.println("the byte is " + lastencryptblock[i]);
					}
				}*/
				
System.out.println("the total block  is " + totalblock + " the lastencryptblock size is " + encrypt(lastblock).length);					
...
System.out.println("the src size is " + src.length);
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, ShortBufferException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, IOException
    {
    	/*AES aes = null;
    	aes = new AES();
 ...
 /*   	AES aes = new AES();
    	...
    	String miwen = aes.encryptString(str1, "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh");
    	//System.out.println("the miwen is " + miwen);
    	
    	
    	AES aes2 = new AES();
    	System.out.println(aes2.decryptString(miwen, "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh"));*/
      ...
      //  dump("iv", iv);
        ...
        //AES aes = new AES();
        //System.out.println("the string is " + aes.encryptString("123456", "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh"));
        //aes.encryptString("123456", "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh");
        
        //System.out.println(aes.decryptString(aes.encryptString("123456", "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh"), "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh"));
      //  dump("indata", indata);
        /*
        AES aes = new AES();
...
/*for(int i=0; i<outdata.length; i++) {
	...
	System.out.println(outdata[i]);
       ...
       //FileHelper fileHelper = new FileHelper();
       /*String pathfile = "D:/bgimage.jpg";
        String pathfile2 = "D:/bgimage2.jpg";
        
        byte[] src = fileHelper.getContent(pathfile);
        byte[] srcs = new byte[128+16];
        ...
        /*String [] filename = {"11.wav","11.7z","11.aac","11.bmp","11.gif",
        		...
        		"11.tif","11.wma","11.xls"};
        String path = "C:/Users/LiZhen/Desktop/chen-jiami/";
        String path2 = "C:/Users/LiZhen/Desktop/chen-jiemi/";
        String pathfile = null;
        for(String str:filename){
        	pathfile = path+str;
        	byte[] src = fileHelper.getContent(pathfile);
        	byte[] outde = aes.decrypt(src);
        ...
        byte[]  src = fileHelper.getContent("C:/Users/Chen/Desktop/我最亲爱的.mp3");
        dump("src", src);
        byte[] out = aes.encrypt(src);
        fileHelper.createFile("C:/Users/Chen/Desktop/我最亲爱的.mp3", out);
        dump("outdata", out);
        
       byte[] srcen = fileHelper.getContent("C:/Users/Chen/Desktop/我最亲爱的.mp3");
        System.out.println("######:1"+srcen.length);
        byte[] outde = aes.decrypt(srcen);
        System.out.println("######:1"+outde.length);
       ...
       /* for(int i=0;i<1024;i++){
    	...
    	//aes.encryptFile("C:/Users/Chen/Desktop/Navicat_for_MySQL_11.0.10_XiaZaiBa (2).exe", "0123456789abcdef", "fedcba9876543210");
    	
    	//aes.decryptFile("C:/Users/Chen/Desktop/Navicat_for_MySQL_11.0.10_XiaZaiBa (2).exe", "0123456789abcdef", "fedcba9876543210");
    	//System.out.println(aes.encryptString("123456", "4qcybhikgmbb18g5", "hjf3zdzspdvk4fbh"));
    }
