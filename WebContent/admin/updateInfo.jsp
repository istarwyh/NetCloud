...
<div class="cztable">
	<form action="admin/admin_updateinfodeal.action" method="post"  id="form1"  name="form1" onsubmit="return tsubmit()">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="15%" align="right"><div align="right">用户名： </div></td>
            <td><input  size="20" name="username" value="${admin.username }" class="input_2" id="username" placeholder="6-20个字母或者数字" required/></td>
        </tr>
        <tr>
            ...
            <td>
                <select id="Ctype" name="department">
                	<c:forEach items="${departmentList}" var="department">
                    	<c:if test="${admin.department == department.id}">
